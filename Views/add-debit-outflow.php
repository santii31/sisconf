...
<div class="col s12 m8 l10">
            <div class="main-content">
                <div class="row">
                    <form action="<?= FRONT_ROOT ?>outflow/addOutflow" method="post" class="col s10 form-test">
                        ...
                        <label>Egreso efectuado con tarjeta de debito perteneciente al banco: <label class="othera"><?php echo $bankName; ?></label> . </label>
